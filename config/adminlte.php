...
return [
    ...
    */
    ...
    'logo' => '<b>Minha</b>Escola',
    'logo_img' => 'vendor/adminlte/dist/img/AdminLTELogo.png',
    'logo_img_class' => 'brand-image img-circle elevation-3',
    'logo_img_xl' => null,
    'logo_img_xl_class' => 'brand-image-xs',
    'logo_img_alt' => 'Minha Escola',
    ...
    'menu' => [
        ...
        [
            ...
            'submenu'  => [
                ...
                [
                    'text'  => 'Escola',
                    'url'   => 'painel/cadastro/escola',
                    'icon'  => 'nav-icon far fa-circle text-success',
                    'can'   =>'CEO',
                ], 
                [
                    'text'  => 'Professor',
                    'url'   => 'painel/cadastro/professor',
                    'icon'  => 'nav-icon far fa-circle text-success',
                    'can'   =>'MAS',
                ],   
                [
                    'text'  => 'Aluno',
                    'url'   => 'painel/cadastro/aluno',
                    'icon'  => 'nav-icon far fa-circle text-success',
                    'can'   =>'MAS',
                ],
                [
                    'text'  => 'Materias',
                    'url'   => 'painel/cadastro/materia',
                    'icon'  => 'nav-icon far fa-circle text-success',
                    'can'   =>'MAS',
                ],
            ],
