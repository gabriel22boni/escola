                    ...
                    <form action="" method="POST" id="formCadastro" >
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-10 col-lg-10"><!-- Coluna direita -->
                                <div class="row">
                                    <div class="form-group col-sm-4">
                                        <label for="idadmVer">Professor</label>
                                        <select class="form-control" disabled="">
                                            <option name="idadmVer" class="formDataVer" id="idadmVer">Professor Nome</option>
                                        </select>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        @if(
                                            ...
                                            <div class="form-group col-sm-4">
                                                <label for="idadmEdit">Professor</label>
                                                <select name="idadmEditSelect" id="idadmEditSelect" class="form-control formDataEditSelect">
                                                    <option name="idadmEdit" class="formDataEdit" id="idadmEdit" value="">Professor Nome</option>
                                                    @foreach($cadAdms as $cadAdm)
                                                        <option value="{{$cadAdm->id}}">{{$cadAdm->nome ?? $cadAdm->fnome}}</option>
                                                    @endforeach                       
                                                </select>
