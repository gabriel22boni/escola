                ...
                @else
                    <a href="{{ $dashboard_url }}" class="navbar-brand {{ config('adminlte.classes_brand') }}">
                        @if(auth()->user()->image != null)
                            <img src="{{ url('storage/users/'.auth()->user()->image) }}" alt="{{ auth()->user()->name }}" style="width:33px;height:33px;opacity: .8" class="brand-image img-circle elevation-3">
                        @else
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <center>
                                        ...
                                        <span class="dropdown-item" style="font-size:12px">{{ auth()->user()->email }}</span>
                                    </center>
                                    </br>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="{{route('perfil')}}"><i class="fas fa-user-edit"></i>  Editar Perfil</a>
                                    <div class="dropdown-divider"></div>
